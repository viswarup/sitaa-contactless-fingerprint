...
- **Track B (Implemented): Enhancement**
    ...
    - *Experiment 2*: **MobileNetV2 with U-Net Segmentation Head**.
        ...
        - *Comparison*: We experimented with **Canny Edge Detection** (with Watershed) and Convex Hull. While effective in controlled lighting, they failed in challenging real-world lighting. MobileNetV2 proved significantly more robust.
