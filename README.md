...
- **Track B (Implemented): Enhancement**
    ...
    - *Experiment 1* : We experimented with **Gabor Filter, Skeletonization(Thinning Ridges), and Minutiae Detection** but it did not give good results, hence it is not included in the application. A report regarding our experimenation with tradional Computer Vision Methods is in the repo with the file name "traditional_CV_experimentation_report.pdf".
